 ...
 */
final class Version20190509154708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE boite_postale boite_postale VARCHAR(255) DEFAULT NULL, CHANGE site site VARCHAR(255) DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE secteur_activiter secteur_activiter VARCHAR(255) DEFAULT NULL');

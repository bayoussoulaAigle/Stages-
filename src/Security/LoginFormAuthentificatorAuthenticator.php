...
class LoginFormAuthentificatorAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException('votre email ou mot de passe est incorrect.');
        }
    ...
    {       $user = $this->security->getUser();
      ...
      //  throw new \Exception('TODO: provide a valid redirect inside '.__FILE__);
        ...
        if($user->getFonction() === "entreprise"){
            return new RedirectResponse($this->urlGenerator->generate('stage_entreprise'));
        }
        if($user->getFonction() === "etudiant"){
            return new RedirectResponse($this->urlGenerator->generate('stage_etudiant'));
        }
        if($user->getFonction() === "professeur"){
            return new RedirectResponse($this->urlGenerator->generate('stage_professeur'));
        }
    }
